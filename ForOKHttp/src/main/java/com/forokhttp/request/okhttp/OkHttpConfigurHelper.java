 ...
 */
public class OkHttpConfigurHelper {

    private List<Paint> commonParams;
    protected Headers commonHeaders;
    private List<InputStream> certificateList;
    private HostnameVerifier hostnameVerifier;
    private long timeout = RequestTime.QUEYEST_TIME;
    ...
    private OkHttpConfigurHelper(final Builder builder) {
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setCommenParams(List<Paint> params){
        ...
        public OkHttpConfigurHelper build() {
            return new OkHttpConfigurHelper(this);
        }
    }
